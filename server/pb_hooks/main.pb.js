...
routerAdd('POST', '/custom/gpt-answer', (c) => {
  ...
  const promt_10 = `Глубоко вдохни. Думай пошагово. Тебе заплатят 500$ за решение этой проблемы.
  Ты декомпозитор целей. 
  Пользователь отправит тебе от 1 до 5 целей, которые нужно достичь за 10 лет.
  ...
  Необходима конкретика, план, roadmap, пошаговое описание. Дай ему полезные советы.
  Вот цели на 10 лет, которые пользователь нам прислал:
  ${goal_str}
  `
  const promt_5 = `Глубоко вдохни. Думай пошагово. Тебе заплатят 500$ за решение этой проблемы.
  Ты декомпозитор целей. 
  ...
  ${goal_str}
  `
  const promt_1 = `Глубоко вдохни. Думай пошагово. Тебе заплатят 500$ за решение этой проблемы.
  Ты декомпозитор целей. 
